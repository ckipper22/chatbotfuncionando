...
// A verificação `process.env.GEMINI_API_KEY |

| ''` é uma boa prática para evitar falhas em tempo de execução
...
      if (libResult.includes("Não encontrei informações") |

| libResult.includes("Não tenho a informação")) {
